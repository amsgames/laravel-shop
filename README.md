...
The gateway will require those 2 methods as minimun. You can add more depending your needs.
...
To properly generate the transaction there are 2 properties you must consider on setting during `onCharge`:
